...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText homeTeam_input;
    private EditText awayTeam_input;
    private ImageView homeLogo;
    private ImageView awayLogo;
    private Button buttonTeam;
    private Uri homeImage;
    private Uri awayImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeTeam_input = findViewById(R.id.home_team);
        awayTeam_input = findViewById(R.id.away_team);
        ...
        buttonTeam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // intent
                homeTeam = homeTeam_input.getText().toString();
                awayTeam = awayTeam_input.getText().toString();
                Intent intent = new Intent(MainActivity.this, MatchActivity.class);
                intent.putExtra("name_home", homeTeam);
                intent.putExtra("name_away", awayTeam);
                intent.putExtra("home_image", homeImage.toString());
                intent.putExtra("away_image", awayImage.toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == RESULT_CANCELED){
            Log.d(TAG, "Batal pilih gambar");
            return;
        }
        else if(resultCode == HOME_REQUEST_CODE){
            if(data != null){
                try {
